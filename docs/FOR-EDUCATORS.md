...
2. **A reference implementation to use, fork, or critique.** The 35 skills currently in this repository are immediately usable as reading material, discussion prompts, or installed AI tooling. They can also be forked and modified, or used as material for student critique.
...
Faculty wishing to adopt the project beyond use of the current 35 skills have several paths:
