...
The 35 skills in this repository reflect one author's reading of one set of source materials. They are presented as an **existence proof** of the methodology — what the method produces in practice — not as authoritative content.
...
Even within the project's chosen scope — early- to mid-career software engineering practice — the current 35 skills do not cover every recurring situation a learner may face. Known gaps include:
