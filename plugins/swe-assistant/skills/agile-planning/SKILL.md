---
name: agile-planning
description: Use when the user is planning or estimating work inside an agile process — writing or reviewing a user story, being asked for a story point estimate, breaking a story into tasks, sizing a sprint, grooming a backlog, scoping a spike, or contributing to a quarterly roadmap. Triggers include "how do I estimate this", "what's a story point", "how many points is this", "sprint planning", "we always overcommit", "how do I write a user story", "acceptance criteria", "backlog grooming", "should this be a spike", "how do I break this story down", "our sprints never finish", "roadmap planning", "scrum vs kanban", or "our team wants to try kanban". Introduces agile planning from The Missing Readme (Ch. 12) — the manifesto's values, Scrum and Kanban, stories, spikes, tasks, estimation, and roadmaps. For standups, reviews, and retrospectives, route to team-rituals. For deciding what to build at all, route to technical-design-process.
---
