...
description: Use when the user is about to ask a colleague for help, is hesitating to ask, is drafting a question, has been stuck a while and wonders whether to keep digging, or is reflecting on whether they ask too much or too little. Triggers include "I don't want to interrupt", "how do I ask without sounding dumb", "I've been stuck for hours", or "should I ask or keep trying". Covers doing your research first, timeboxing before asking, showing your work, and preferring async and multicast over interrupting. Goal — be neither a drain nor a martyr. Skip when the user is asking the AI directly, or asking how to prompt AI tools.
---
