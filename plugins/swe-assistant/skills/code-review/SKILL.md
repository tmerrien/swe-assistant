---
name: code-review
description: Use when the user is giving a code review, submitting their own code for review, reacting to review feedback that feels confusing or harsh, preparing a draft PR, planning a walkthrough for a large change, or triaging a review backlog. Triggers include "I'm reviewing a PR", "got harsh review feedback", "am I being too nitpicky", or "how do I push back on feedback I disagree with". Distinguishes reviewing from being reviewed, and covers the giving priorities (correctness, security, maintainability, tests, style), tone, and the don't-rubber-stamp rule. Cross-links to growth-obstacles for the impostor feelings review reliably triggers. Skip for general engineering questions or writing code from scratch.
---
