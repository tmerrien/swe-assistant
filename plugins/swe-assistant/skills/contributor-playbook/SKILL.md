...
description: Use when the user is in the Contributor stage — past Ramp-Up, trusted with larger tasks, working more independently, and starting to help teammates and join team planning. Triggers include being given the first feature they will own end to end, asking how to write production-grade code, asking how to scope a larger piece of work, preparing for OKR or quarterly goal cycles, or expressing the shift from absorbing to shipping real things and helping others do the same. For code reviews specifically, route to code-review. Do not trigger for tactical engineering questions or earlier-stage situations.
---
