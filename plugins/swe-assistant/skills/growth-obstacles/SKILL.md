...
description: Use when the user is expressing self-doubt about their competence, is showing overconfidence about something they may not fully understand, or is asking for help calibrating their self-assessment. Triggers include "I feel like a fraud", "everyone else seems to know more", "I'm not ready for this", "this is easy, I can do it in a day" when the scope is large, or "I don't need to check with anyone" in unfamiliar territory. Covers impostor syndrome and Dunning-Kruger with concrete calibration practices, so the user can see themselves accurately. Skip for general growth reflection (route to growth-self-check) or tactical engineering questions.
---
