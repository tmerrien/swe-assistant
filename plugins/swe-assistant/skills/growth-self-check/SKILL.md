...
description: Use when the user is reflecting on their own growth as a software engineer — before a 1:1 or performance review, considering readiness for the next level, deciding what to learn or which project to take for development reasons, or expressing uncertainty about whether they are getting better. Walks the four pillars — Technical Knowledge, Execution, Communication, Leadership — as a self-check, offers one observation per pillar rather than only questions, and routes to the skill that helps with their weakest. Do not trigger for team retrospectives (route to team-rituals), or for the mechanics of the manager relationship — 1:1 agendas, status updates, OKR wording, review evidence (route to working-with-managers).
---
