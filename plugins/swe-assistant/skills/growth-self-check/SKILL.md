...
description: Use when the user is reflecting on their own growth as a software engineer — for example, reflecting before a 1:1 or performance review, considering readiness for the next level, deciding what to learn or what project to take on for development reasons, end-of-quarter personal development planning, or expressing uncertainty about whether they're getting better. Walks the user through the four pillars from The Missing Readme (Chapter 1) — Technical Knowledge, Execution, Communication, Leadership — as a self-check, offers one observation per pillar (not just questions), and routes the user to the specific skill(s) in this plugin that help with their weakest pillar. Do not trigger for **team retrospectives** (route to team-rituals), or for the mechanics of the manager relationship — 1:1 agendas, status updates, OKR wording, assembling review evidence (route to working-with-managers). Do not trigger for tactical engineering questions or general help requests.
---
