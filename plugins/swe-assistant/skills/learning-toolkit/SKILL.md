...
description: Use when the user is trying to learn something deliberately — a codebase, system, language, tool, or domain — rather than just ship a specific thing. Triggers include asking how to learn an unfamiliar codebase, how to get good at debugging or a particular tool, how to read code effectively, whether a side project is worth it, or expressing that they don't feel like they are learning enough. Covers front-loading learning, learning by doing, experimenting with code, reading widely, watching talks, pairing and shadowing, and side projects. Goal — reach conscious competence quickly. Skip for tactical engineering questions, or when the user just wants the answer so they can ship.
---
