...
description: Use when the user is in, or about to enter, the early days at a new company, team, or role — about to start, first days, first week, first month, transferring between teams, or feeling lost as a new hire. Triggers include asking how to onboard well, or what to focus on in the first 30 or 90 days. Covers setting up the environment, attending the right meetings, building relationships, learning the codebase through small low-stakes changes, and documenting what you learn so the next hire has it easier. Always leads with the mindset for this stage — understand the system and the people, not impress. Do not trigger for general career questions, or for tactical engineering help unrelated to onboarding.
---
