---
name: on-call-shift
description: Use when the user is on call, about to go on call, or thinking about how their shift works — the day-to-day of holding the pager, not an active incident. Triggers include "I'm on call this week", "my first on-call shift", "I'm drowning in support requests", "how do I prioritize on-call work", "what's a P1 vs a P2", "on-call handoff", or "on-call is burning me out". Covers availability, the P0–P4 priority ladder, SLI versus SLO versus SLA, communicating clearly, tracking work in tickets, the support-request lifecycle, and not being a hero. For an active production incident, route to incident-response. For the broader Operator-stage picture, route to operator-playbook.
---
