---
name: owner-playbook
description: Use when the user is in the Owner stage — trusted to drive small projects, design software, and think about the system rather than just code in it. Triggers include taking on a project end to end, asking how to approach design before coding, exploring trade-offs or planning for system evolution, identifying flaws in the architecture or the build and deploy environment, balancing new work against maintenance, or preparing for a career conversation. Routes to design-doc for design documents, code-review for reviews, and growth-self-check for personal reflection. Skip for tactical engineering questions or earlier-stage situations.
---
