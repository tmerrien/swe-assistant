...
description: Use when the user wants to stress-test their own understanding of a concept, plan, design, or piece of code, through Socratic dialogue that surfaces unexamined assumptions and forces concreteness. Triggers include "stress-test my understanding", "quiz me on X", "poke holes in my plan", "check my mental model", "am I actually sure I get this", "test me before I ship", or "I want to defend this plan first". Runs a loop — force articulation, probe assumptions, stress-test with counter-cases — until the user defends the model end to end or names what is still fuzzy. For general teaching do not trigger; here the user does the explaining. For in-flight code review, route to code-review. For deliberate study of an unfamiliar topic, route to learning-toolkit.
---
